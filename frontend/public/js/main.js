window.collaxInitPlugins = function ($) {
	"use strict";

	var windowOn = $(window)
	///////////////////////////////////////////////////
	// 01. PreLoader Js
	windowOn.off('load.collax preloader').on('load.collax preloader', function () {
		$('#loading').fadeOut(500);
	});
	...
	///////////////////////////////////////////////////
	// 03. scroll-to-target 
	windowOn.off('scroll.collax scrollToTarget').on('scroll.collax scrollToTarget', function () {
	...
	///////////////////////////////////////////////////
	// 06. PreLoader Js
	windowOn.off('load.collax preloader2').on('load.collax preloader2', function () {
		$("#loading").fadeOut(500);
	...
	///////////////////////////////////////////////////
	// 07. Sticky Header Js
	windowOn.off('scroll.collax stickyHeader').on('scroll.collax stickyHeader', function () {
		var scroll = windowOn.scrollTop();
		if (scroll < 300) {
	...
	////////////////////////////////////////////////////
	// 09. Sidebar Js
	$(".tp-menu-bar").off("click").on("click", function () {
